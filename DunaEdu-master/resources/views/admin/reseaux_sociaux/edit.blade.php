                ...
                <div class="col-lg-12 mx-auto">
                    <div class="enrollment-form-wrapper">
                        <div class="enrollment-header text-center mb-5" data-aos="fade-up" data-aos-delay="200">
                            <h2>Mettre à Jour les Informations du Réseau Social</h2>
                        </div>

                        <form class="enrollment-form" data-aos="fade-up" data-aos-delay="300" method="POST"
                            action="{{ route('reseaux_sociaux.update', $reseauSocial->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" name="nom" class="form-control" required
                                        value="{{ old('nom', $reseauSocial->nom) }}">
                                </div>
                                <div class="col-lg-4 mb-3">
                                    <label class="form-label">Url *</label>
                                    <input type="text" name="url" class="form-control" required
                                        value="{{ old('url', $reseauSocial->url) }}">
                                </div>
                                <div class="col-lg-4 mb-3">
                                    <label class="form-label">Icone</label>
                                    <input type="text" name="icone" class="form-control"
                                        value="{{ old('icone', $reseauSocial->icone) }}">
                                </div>
                            </div>
