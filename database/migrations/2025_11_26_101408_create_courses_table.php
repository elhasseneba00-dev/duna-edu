...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            $table->foreignId('category_id')->nullable()->constrained('categories')->nullOnDelete(); // course creator/teacher
            ...
            $table->string('level_fr')->nullable(); // beginner, intermediate, advanced
            $table->string('level_en')->nullable(); // beginner, intermediate, advanced
            $table->string('level_ar')->nullable(); // beginner, intermediate, advanced
