                ...
                <div class="col-lg-12 mx-auto">
                    <div class="enrollment-form-wrapper">
                        <div class="enrollment-header text-center mb-5" data-aos="fade-up" data-aos-delay="200">
                            <h2>Mettre à Jour les Informations du Module</h2>
                        </div>
                                ...
                                <select name="course_id" class="form-control" required>
                                    @foreach ($courses as $course)
                                        <option value="{{ $course->id }}"
                                            {{ $module->course_id == $course->id ? 'selected' : '' }}>
                                            {{ $course->title_fr }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        ========================== --}}
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title_fr" class="form-control"
                                        value="{{ $module->title_fr }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Description (FR)</label>
                                    <textarea name="description_fr" rows="3" class="form-control">{{ $module->description_fr }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="description_en" rows="3" class="form-control">{{ $module->description_en }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="description_ar" rows="3" class="form-control">{{ $module->description_ar }}</textarea>
                                </div>
                            </div>
