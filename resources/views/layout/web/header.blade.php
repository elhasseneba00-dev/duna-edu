          ...
          <nav id="navmenu" class="navmenu">
              <ul>
                  ...
                  {{-- <li class="dropdown">
                      ...
                      <ul>
                          <li><a href="/societe" class="{{ request()->is('societe*') ? 'active' : '' }}">DunaEdu</a></li>
                  ...
                  <li class="dropdown">
                      ...
                      <ul>
                          ...
                          <li><a href="/benefices"
                                  class="{{ request()->is('benefices*') ? 'active' : '' }}">Pourquoi Nous Choisir ?</a></li>
                      </ul>
                  </li> --}}
                  <li><a href="/fr">Accueil</a></li>
                  <li><a href="/about/fr">A propos</a></li>
                  <li><a href="/course/fr">Cours</a></li>
                  <li><a href="/instructors/fr">Instructeurs</a></li>
